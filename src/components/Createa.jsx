...
const Createa = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8082/create-auditorium-post", formData, {
        headers: {
          "Content-Type": "multipart/form-data"
        }
      });
      setMessage("Auditorium post created successfully!"); // Success message
  ...
  return (
    <div>
      ...
      <div className="container">
        <h2>Create a New Auditorium Post</h2>
