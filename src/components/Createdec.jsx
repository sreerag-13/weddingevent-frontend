...
import Nav3 from './Nav3'; // Import your navigation component
...
const Createdec = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:8082/create-decoration-post", formData, {
        headers: {
          "Content-Type": "multipart/form-data"
        }
      });
      setMessage("Decoration post created successfully!"); // Success message
  ...
  return (
    <div>
      {/* Include the Nav3 navigation component */}
      <Navd />

      <div className="container">
        <h2>Create a New Decoration Post</h2>
