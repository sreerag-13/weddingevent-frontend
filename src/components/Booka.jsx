...
import './Booka.css'; // Import your custom CSS for Booka
import { FaPlus, FaTrash, FaCalendarCheck } from 'react-icons/fa'; // Import icons for UI
    ...
    return (
        <div style={containerStyle}>
                ...
                <div>
                    {pricingDetails.map((pricing) => (
                        <div key={pricing._id} className="pricing-card">
                            ...
                            >
                                <FaPlus /> Add to Cart {/* Include Add icon */}
                            </button>
                        </div>
                    ))}
                </div>
            ...
            <div style={{ marginTop: '20px' }}>
                <h3><FaCalendarCheck /> Select a Date for Booking:</h3> {/* Include Calendar icon */}
                <DatePicker
